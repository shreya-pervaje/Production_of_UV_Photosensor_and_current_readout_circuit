...
plt.plot(timen,-currentn2*1000,'o',markersize=2)    
plt.plot(timen[c],-currentn[c]*1000,'bx',label='90% of the difference')    
plt.plot(timen[d],-currentn[d]*1000,'rx',label='10% of the difference')
...
plt.tight_layout()
plt.savefig('plot_batch3_ps_100um_10um_response_time_up.png')