...
U_Gate, I_Drain = np.genfromtxt("SP2_Batch2_10u_10u_TFT_Measurement4.txt", delimiter= '\t', unpack = True) 
...
plt.tight_layout()
plt.legend()
plt.savefig('eval_batch2_SP2_TFT_threshold_voltage_mobility_without_dielectric.png')
