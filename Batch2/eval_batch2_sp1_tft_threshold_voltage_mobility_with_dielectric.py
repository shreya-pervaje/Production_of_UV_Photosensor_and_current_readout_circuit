...
U_Gate, I_Drain = np.genfromtxt("SP1_Batch2_10u_10u_WithDielectric_TFT_Measurement4.txt", delimiter= '\t', unpack = True) 
...
plt.tight_layout()
plt.legend()
plt.savefig('Eval_batch2_SP1_TFT_threshold_voltage_mobility_with_dielectric.png')
